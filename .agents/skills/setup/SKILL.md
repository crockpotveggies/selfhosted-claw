...
> Run `Codex setup-token` in another terminal. It will output a token — copy it but don't paste it here.
...
1. Use the Read tool to read `.Codex/skills/setup/diagnostics.md`.
